...
const reviews = [
    {
        ...
        author:`- Night Shift Nurse<br>Regular at Bar Seat #7`
    },
    {
        stars: "&star;&star;&star;&star;&star;",
        quote:`"I came for the cocktails. I stayed for the chaos."`,
        author:`- Line Cook Still wearing Their Apron <br> Regular at Seat #4`
    },
    {
        stars: "&star;&star;&star;&star;&star;",
    ...
    {
        stars: "&star;&star;&star;&star;&star;",
        quote:`"It feels like I'm sitting at the bar with the friends who should not be trusted."`,
        author:`- Weekend Warrior<br>Definitely Not Driving`
    },
    {
        stars: "&star;&star;&star;&star;&star;",
        quote:`"Good stories and great drinks, what more could a girl ask for?"`,
        author:`- Bartender Off The Clock<br>Reagulat at Seat #12`
    },
];
let currentReview = 0;
function updateReview(index) {
    reviewStars.innerHTML = `<span>${review[index].stars}</span>`;
    reviewText.textContent = reviews[index].quote;
    reviewAuthor.innerHTML = review[index].author;
