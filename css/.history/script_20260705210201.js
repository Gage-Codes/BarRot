...
const recipes = {
        ...
        "episode-two": {
            episode: "Episode 02",
            title: "We are looking at the requests off. Will be posted soon.",
            ingredients: [
                "Recipe coming soon."
            ],
            method: [
        ...
        "episode-three": {
            episode: "Episode 03",
            title: "Still working on it. Make sure availability is updated.",
            ingredients: [
                "Recipe coming soon."
            ],
            method: [
...
cocktailSelect.addEventListener("change", function () {
    ...
    selectedRecipe.ingredients.forEach(function (ingredient) {
        recipeMethod.innerHTML += `<li>${ingredient}</li>`;
    });
