...
function loadLatestEpisode() {
    ...
    const episodeDescription2 = document.getElementById("episode-description-2");
    ...
    episodeDescription1.textContent = latestEpisode.description1;
    episodeDescription2.textContent = latestEpisode.description2;
