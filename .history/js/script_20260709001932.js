...
function loadLatestEpisode() {
    ...
    episodeDescription.textContent = latestEpisode.description;
    ...
    spotifyButton.rel = "nooperner noreferrer";
}
loadLatestEpisode();
...
contactForm = document.addEventListener("submit", async function (event) {
    ...
    try {
        ...
        if (resonse.ok) {
            formStatus.textContent = "Last call recived. Thanks for sending us your story.";
            contactForm.reset();
        } else {
