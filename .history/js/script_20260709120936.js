...
//Episode Section/Episode Spotlight// 

function loadLatestEpisode() {
    const episodeNumber = document.getElementById("episode-number");
    const episodeTitle = document.getElementById("episode-title");
    const episodeDescription1 = document.getElementById("episode-description-1");
    const episodeDescription2 = document.getElementById("eoisode-description-2");
    const episodeRuntime = document.getElementById("episode-runtime");
    const episodeDate = document.getElementById("episode-date");
    const episodeDrink = document.getElementById("episode-drink");
    const episodeCover = document.getElementById("episode-cover");
    const spotifyButton = document.getElementById("spotify-button");
    episodeNumber.textContent = latestEpisode.number;
    episodeTitle.textContent = latestEpisode.title;
    episodeDescription1.textContent = latestEpisode.episodeDescription1;
    episodeDescirption2.textContent = latestEpisode.episodeDescirption2;
    episodeRuntime.textContent = latestEpisode.runtime;
    episodeDate.textContent = latestEpisode.date;
    episodeDrink.textContent = latestEpisode.drink;
    episodeCover.src = latestEpisode.cover;
    spotifyButton.href = latestEpisode.spotifyLink;
    spotifyButton.target = "_blank";
    spotifyButton.rel = "noopener noreferrer";
}
loadLatestEpisode();

//Recipe Section/Card Switcher// 
...
function updateRecipe (selectedRecipe) {
    recipeContent.classList.add("fade-out");
    setTimeout(function () {
        ...
        recipeContent.classList.remove("fade-out");
    }, 500);
}
...
const reviews = [
    {
        ...
        quote:`"Listening feels like clocking out after a Friday night double."`,
        author:`- Night Shift Nurse<br>Regular at Seat #7`
    },
    {
        stars: "&star;&star;&star;&star;&star;",
        quote:`"I came for the cocktails. I stayed for the chaos."`,
        author:`- Kitchen Manager <br> Regular at Seat #4`
    },
    {
        stars: "&star;&star;&star;&star;&star;",
        quote:`"The stories somehow make my own bad decisions feel normal."`,
        author:`- Closing Time Kelly<br>Professional Last Caller`
    },
    {
        stars: "&star;&star;&star;&star;&star;",
        quote:`"It feels less like a podcast and more like pulling up a barstool."`,
        author:`- Double Vodka Dan<br>Definitely Not Driving`
    },
    {
        stars: "&star;&star;&star;&star;&star;",
        quote:`"Good stories and great drinks, what more could a girl ask for?"`,
        author:`- Industry Insider<br>Regular at Seat #12`
    },
];
let currentReview = 0;
function updateReview(index) {
    ...
    setTimeout(function () {
        ...
        reviewText.innerHTML = reviews[index].quote;
...
contactForm.addEventListener("submit", async function (event) {
    ...
    try {
        ...
        if (response.ok) {
            formStatus.textContent = "Last call received. We look forward to reading it.";
            contactForm.reset();
        } else {
            formStatus.textContent = "Something spilled. Try sending it again.";
        }
    } catch (error) {
        formStatus.textContent = "Something spilled. Try sending it again.";
    }
    submitButton.textContent = "Send It Our Way";
